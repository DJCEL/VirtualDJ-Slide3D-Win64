...
public:
    ...
    // For OpenGL texture needs to point to a GLuint, for DirectX 9, it needs to point to a IDirect3DTexture9*, for DirectX 11, it needs to point to a ID3D11ShaderResourceView*
